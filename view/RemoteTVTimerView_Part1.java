...
public class RemoteTVTimerView extends JFrame {
    ...
    private void initUI() {
        ...
        // Device table with new columns for MAC, Name, Version
        deviceTableModel = new DefaultTableModel(new Object[]{"IP Address", "MAC Address", "Name", "Version", "Device Type"}, 0);
